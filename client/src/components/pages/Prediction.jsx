...
const Prediction = () => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    "https://script.google.com/macros/s/AKfycbxn00JdZaEk5mLAqrr41ZrZqs3J6y-uHpshHkWj3pAWg-0Bq6e9Au5lr5KVbuM3fJhcnQ/exec"
                );
    ...
    useEffect(() => {
        if (formData && formData.length) {
            ...
            if (formData[mainIndex]["Q2"] == 0) {
                ...
                formData[mainIndex]["Q2"] < 5 &&
                formData[mainIndex]["Q2"] > 0
            ) {
            ...
            if (formData[mainIndex]["Q5"] <= 3) {
                ...
                formData[mainIndex]["Q5"] >= 4 &&
                formData[mainIndex]["Q5"] <= 7
            ) {
            ...
            const tempScore =
                riskValues.secureIncome[formData[mainIndex]["Q1"]] +
    ...
    const fetchData2 = async (data) => {
        await axios
            .get(
                `https://nehaarane-crispy-trout-gwvpjpjjgjr397p9-5000.preview.app.github.dev/risk-calculation/${data}`
            )
            .then(async (response) => {
                ...
                if (tempPieData["Mutual Funds"] < 15) {
                    tempPieData["Mutual Funds"] = 15;
                    tempPieData["Stock"] -= 15;
                }
    ...
    useEffect(() => {
        const fetchStocksData = async () => {
            await axios
                .get(
                    `https://nehaarane-crispy-trout-gwvpjpjjgjr397p9-5000.preview.app.github.dev/recommendStock?riskFree=${riskFree}&marketReturn=${marketReturn}`
                )
                .then((response) => {
        ...
        const fetchMFData = async () => {
            await axios
                .get(
                    `https://nehaarane-crispy-trout-gwvpjpjjgjr397p9-5000.preview.app.github.dev/recommendMF?riskFree=${riskFree}&marketReturn=${marketReturn}`
                )
                .then((response) => {
    ...
    useEffect(() => {
        axios
            .get(
                `https://nehaarane-crispy-trout-gwvpjpjjgjr397p9-5000.preview.app.github.dev/predictstock/${propsData}`
            )
            .then((response) => {
        ...
        <div className="dashboard-container">
            ...
            >
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogBody>Login to get personalized data !</AlertDialogBody>
                    <AlertDialogFooter>
                        <Button
                            colorScheme="green"
                            ml={3}
            ...
            <div className="container-fluid" style={{ margin: 0, padding: 0 }}>
                <div className="row">
                                    ...
                                    <div className="" style={{ paddingBottom: "30px" }}>
                                        ...
                                        >
                                            <div className="col-md-auto">
                                                ...
                                                >
                                                    <path
                                                        d="M29.0265 5.84127V25.1587C29.0265 27.8471 26.8471 30.0265 24.1587 30.0265H5.84127C3.1529 30.0265 0.973545 27.8471 0.973545 25.1587V5.84127C0.973545 3.1529 3.1529 0.973545 5.84127 0.973545H9.05173H21.7241H24.1587C26.8471 0.973545 29.0265 3.1529 29.0265 5.84127Z"
                                                        fill="white"
                                                        stroke="white"
                                                        stroke-width="1.94709"
                                                        stroke-linecap="round"
                                                    />
                                                    <path
                                                        d="M5.55632 15.787H9.26356C9.3787 15.787 9.48794 15.736 9.56193 15.6478L12.7111 11.8931C12.8813 11.6901 13.2002 11.7127 13.3401 11.9376L17.7545 19.0333C17.8995 19.2664 18.2336 19.2803 18.3975 19.0601L20.7173 15.9439C20.7908 15.8452 20.9066 15.787 21.0297 15.787H23.8896"
                                                        stroke="#2A2E30"
                                                        stroke-width="1.94709"
                                                        stroke-linecap="round"
                                                    />
                                        ...
                                        >
                                            <div className="col-md-auto">
                                                ...
                                                >
                                                    <path
                                                        d="M29.0265 5.84127V25.1587C29.0265 27.8471 26.8471 30.0265 24.1587 30.0265H18.3333H12.2222H5.84127C3.1529 30.0265 0.973545 27.8471 0.973545 25.1587V5.84127C0.973545 3.1529 3.1529 0.973545 5.84127 0.973545H9.05173H21.7241H24.1587C26.8471 0.973545 29.0265 3.1529 29.0265 5.84127Z"
                                                        fill="white"
                                                        stroke="white"
                                                        stroke-width="1.94709"
                                                        stroke-linecap="round"
                                                    />
                                                    <path
                                                        d="M6.66602 17.7964H11.8899M15.87 17.7964H23.3327M6.91477 22.389H15.87M23.3327 22.389H19.8501"
                                                        stroke="#2A2E30"
                                                        stroke-width="1.94709"
                                                        stroke-linecap="round"
                                                    />
                                        ...
                                        >
                                            <div className="col-md-auto">
                                                ...
                                                >
                                                    <path
                                                        d="M24.0322 13.4207C24.0322 18.8393 19.4944 23.2786 13.8382 23.2786C8.18202 23.2786 3.64422 18.8393 3.64422 13.4207C3.64422 8.00213 8.18202 3.5628 13.8382 3.5628C19.4944 3.5628 24.0322 8.00213 24.0322 13.4207Z"
                                                        fill="white"
                                                        stroke="white"
                                                        stroke-width="1.79235"
                                                    />
                                                    <path
                                                        d="M22.4668 23.6969L28.6237 30.1493"
                                                        stroke="white"
                                                        stroke-width="1.79235"
                                                        stroke-linecap="round"
                                                    />
                                        ...
                                        >
                                            <div className="col-md-auto">
                                                ...
                                                >
                                                    <path
                                                        d="M10.3534 7.20898H6.84127C3.61522 7.20898 1 9.82421 1 13.0503V26.1588C1 29.3848 3.61523 32.0001 6.84127 32.0001H26.1587C29.3848 32.0001 32 29.3848 32 26.1588V13.0503C32 9.82421 29.3848 7.20898 26.1587 7.20898H23.4483"
                                                        stroke="white"
                                                        stroke-width="1.94709"
                                                        stroke-linecap="round"
                                                    />
                                                    <path
                                                        d="M17.0743 1.69983V16.3908M17.0743 1.69983L13.6299 4.68394M17.0743 1.69983L20.5188 4.68394"
                                                        stroke="white"
                                                        stroke-width="1.94709"
                                                        stroke-linecap="round"
                                                    />
                    ...
                    <div className="col-md-auto" style={{ width: "54vw" }}>
                        ...
                        <div
                            className="container"
                            style={{ margin: 0, padding: 0, width: "80vw" }}
                        >
                            <div className="row">
                                <div className="col-md-auto">
                                    <div
