...
const Dashboard = () => {
  ...
  let mainIndex,userFormData;
  const searchEmail = () => {
      for (let i = 0; i < formData.length; i++) {
          if(formData[i][8] === email){
            mainIndex = i;
            userFormData = formData[mainIndex]
          }
      }
    }
  ...
  function calculateRiskScore() {
    ...
    const riskScore = riskValues.secureIncome[secureIncome]
      + riskValues.financiallyDependent[financiallyDependent]
      + riskValues.emiAllocation[emiAllocation]
      + riskValues.stockInvestmentPreference[stockInvestmentPreference]
      + riskValues.investmentHorizon[investmentHorizon]
      + riskValues.riskAppetite[riskAppetite]
      + riskValues.portfolioAllocation[portfolioAllocation]
